...
To answer these questions, several tasks need to be done from a basic data handing to setting up for visualization. 
...
The dataset used in this project is available at NYC Opean data website. We can download this data from [this link](https://nycopendata.socrata.com/Social-Services/311-Service-Requests-from-2010-to-Present/erm2-nwe9). Due to the size of this dataset, I will load directly from my own computer after downloading the dataset.
...
Let's look at data sample. After filtering, the data has five columns which contain noise information on date, type, region and location(lon, lat) respectively.
